...
public partial class Depositos
{
    ...
    [Column("Deposito_Bill_1")]
    public int? DepositoBill1 { get; set; }

    [Column("Deposito_Bill_2")]
    public int? DepositoBill2 { get; set; }

    [Column("Deposito_Bill_5")]
    public int? DepositoBill5 { get; set; }

    [Column("Deposito_Bill_10")]
    public int? DepositoBill10 { get; set; }

    [Column("Deposito_Bill_20")]
    public int? DepositoBill20 { get; set; }

    [Column("Deposito_Bill_50")]
    public int? DepositoBill50 { get; set; }

    [Column("Deposito_Bill_100")]
    public int? DepositoBill100 { get; set; }
