namespace PortalWeb_API.Models
{
    public class OManual
    {
        ...
        public int Deposit_denom_1
        {
            get
            {
                return _deposit_denom_1;
            }
            set
            {
                _deposit_denom_1 = value;

            }
        }

        private int _deposit_denom_2;
        public int Deposit_denom_2
        {
            get
            {
                return _deposit_denom_2;
            }
            set
            {
                _deposit_denom_2 = value;

            }
        }

        private int _deposit_denom_5;
        public int Deposit_denom_5
        {
            get
            {
                return _deposit_denom_5;
            }
            set
            {
                _deposit_denom_5 = value;

            }
        }

        private int _deposit_denom_10;
        public int Deposit_denom_10
        {
            get
            {
                return _deposit_denom_10;
            }
            set
            {
                _deposit_denom_10 = value;

            }
        }

        private int _deposit_denom_20;
        public int Deposit_denom_20
        {
            get
            {
                return _deposit_denom_20;
            }
            set
            {
                _deposit_denom_20 = value;

            }
        }

        private int _deposit_denom_50;
        public int Deposit_denom_50
        {
            get
            {
                return _deposit_denom_50;
            }
            set
            {
                _deposit_denom_50 = value;

            }
        }

        private int _deposit_denom_100;
        public int Deposit_denom_100
        {
            get
            {
                return _deposit_denom_100;
            }
            set
            {
                _deposit_denom_100 = value;

            }
        }

        private int _deposit_coin_1;
        public int Deposit_coin_1
        {
            get
            {
                return _deposit_coin_1;
            }
            set
            {
                _deposit_coin_1 = value;

            }
        }

        private int _deposit_coin_5;
        public int Deposit_coin_5
        {
            get
            {
                return _deposit_coin_5;
            }
            set
            {
                _deposit_coin_5 = value;

            }
        }

        private int _deposit_coin_10;
        public int Deposit_coin_10
        {
            get
            {
                return _deposit_coin_10;
            }
            set
            {
                _deposit_coin_10 = value;

            }
        }

        private int _deposit_coin_25;
        public int Deposit_coin_25
        {
            get
            {
                return _deposit_coin_25;
            }
            set
            {
                _deposit_coin_25 = value;

            }
        }

        private int _deposit_coin_50;
        public int Deposit_coin_50
        {
            get
            {
                return _deposit_coin_50;
            }
            set
            {
                _deposit_coin_50 = value;

            }
        }

        private int _deposit_coin_100;
        public int Deposit_coin_100
        {
            get
            {
                return _deposit_coin_100;
            }
            set
            {
                _deposit_coin_100 = value;
