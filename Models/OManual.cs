namespace PortalWeb_API.Models
{
    public class OManual
    {
        ...
        public int Deposit_denom_1 { get; set; }
        public int Deposit_denom_2 { get; set; }
        public int Deposit_denom_5 { get; set; }
        public int Deposit_denom_10 { get; set; }
        public int Deposit_denom_20 { get; set; }
        public int Deposit_denom_50 { get; set; }
        public int Deposit_denom_100 { get; set; }
        public int Deposit_coin_1 { get; set; }
        public int Deposit_coin_5 { get; set; }
        public int Deposit_coin_10 { get; set; }
        public int Deposit_coin_25 { get; set; }
        public int Deposit_coin_50 { get; set; }
        public int Deposit_coin_100 { get; set; }
