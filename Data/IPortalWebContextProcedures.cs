...
namespace PortalWeb_API.Data
{
    public partial interface IPortalWebContextProcedures
    {
        ...
        Task<List<SP_EquiposNoTransaccionesResult>> SP_EquiposNoTransaccionesAsync(DateTime? fechaInicial, DateTime? fechaFinal, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
